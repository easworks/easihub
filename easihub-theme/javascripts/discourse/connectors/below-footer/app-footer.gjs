        ...
        <div class="main-footer">
          ...
          <div class="footer-grid">
            ...
            <div class="footer-about footer-section">
              <h3><i class="fa-solid fa-cube"></i> EASIHUB</h3>
            ...
            <div class="footer-navi footer-section">
              <h4><i class="fa-solid fa-compass"></i> Navigation</h4>
              <ul>
            ...
            <div class="footer-communities footer-section">
              <h4><i class="fa-solid fa-network-wired"></i> Platform Communities</h4>
            ...
            <div class="footer-connect footer-section">
              <h4><i class="fa-solid fa-globe"></i> Connect & Support</h4>
          ...
          <div class="code-conduct">
            <h4><i class="fa-solid fa-balance-scale"></i> Community Standards</h4>
